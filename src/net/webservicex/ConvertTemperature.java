    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(net.webservicex.ConvertTemperature.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = net.webservicex.ConvertTemperature.class.getResource(".");
